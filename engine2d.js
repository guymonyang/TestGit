...
(function (map) {
    var SpriteBase = (function (_super) {
        ...
        SpriteBase.prototype.setNotClip = function (noClicp) {
            this.mbNotClip = noClicp;
        };
        SpriteBase.prototype.isNotClip = function () {
            return this.mbNotClip;
        };
        ...
        SpriteBase.prototype.setPositionCellXY = function (cellx, celly) {
            ...
            var y = map.LogicBlock.getYFromCell(celly);
    ...
    var MovableSprite = (function (_super) {
        ...
        MovableSprite.prototype._FireMovementEvent = function (flag) {
            ...
            if ((flag & map.MoveReportFlag.MOVEMENT_BEGIN_RUN) != 0 && (this.report & map.MoveReportFlag.MOVEMENT_TRACE_PATH) != 0) {
                if (this.logicPath) {
                    var num = this.logicPath.GetPathNum();
                    if (num > 0) {
                        var line = this.logicPath.GetPathList();
                        ...
                        this.movementEvent.setPathXY(num, this.logicPath.GetEndX(), this.logicPath.GetEndY());
            ...
            if ((this.report & map.MoveReportFlag.MOVEMENT_TRACE_PATH) != 0) {
                this.movementEvent.walkOnPathIndex = this.logicPath.GetCurrentPathIndex();
        ...
        MovableSprite.prototype._UpdateMovement = function (cam, passTime) {
            if (!this.isEnterMap())
                return false;
            if (!this.mbTickMove || this.logicPath == null)
                return false;
            if (passTime != null) {
                this.logicPath.SetTimeline(passTime);
            }
            else {
                ...
                if (this.mmoving == false) {
                    ...
                    if (shouldStop) {
                        ...
                        if (pos_.x != curX || pos_.y != curY) {
                            ...
                            cell_.y = map.LogicBlock.getCellY(pos_.y);
        ...
        MovableSprite.prototype.setMovementTimeline = function (passTime) {
            return this._UpdateMovement(null, passTime);
        };
...
(function (map) {
    var LogicSprite = (function (_super) {
        ...
        LogicSprite.prototype.getAlpha = function () {
            return this.mAlpha;
        };
        ...
        LogicSprite.prototype.setContentScale = function (s) {
            this.mContentScale = s;
            this._updateScale();
        };
        LogicSprite.prototype.getContentScale = function () {
        ...
        LogicSprite.prototype._updateColor = function () {
        };
...
var core;
(function (core) {
    var ResourcePriority = (function () {
        function ResourcePriority() {
        }
        ResourcePriority.Hight = 10;
        ResourcePriority.Normal = 0;
        ResourcePriority.Low = -10;
        return ResourcePriority;
    }());
    core.ResourcePriority = ResourcePriority;
    __reflect(ResourcePriority.prototype, "core.ResourcePriority");
    ...
    var ResManager = (function (_super) {
        ...
        ResManager.prototype.init = function () {
            ...
            this.mErrorResMap = {};
            // this.mErrorMaxTryTimes = 1;
            this.mLoadQueue = [];
            this.mLoadMaxCount = 2;
            this.mLoadCount = 0;
            this.mPlainTextZipMap = {};
            this.mLogicKey2FilePath = {};
            this.mFilePath2LogicKey = {};
        };
        ...
        ResManager.prototype.injectRESConfig = function () {
            ...
            this.mVersionController = RES.getVersionController();
            this.mbVersionControllerInit = false;
        };
        ResManager.prototype.initRES = function () {
            ...
            RES.addEventListener(RES.ResourceEvent.ITEM_LOAD_ERROR, this.onResByUrlError, this);
        };
        ...
        ResManager.prototype.loadZipRes = function (key) {
            ...
            for (var packetName in this.mPlainTextZipMap) {
                var packetInfo = this.mPlainTextZipMap[packetName];
                var data = packetInfo[key];
                if (data) {
                    if (type == core.ResourceType.TYPE_JSON) {
                        data = JsUtil.JsonDecode(data);
                    }
                    egret.$callAsync(this.onItemLoadSuccess, this, data, key, true);
                    return true;
                }
            }
            ...
            //如果本地存在zip文件
            // for (let k in this.mZipList) {
            // 	let zipobj:JSZipObject = null
            // 	let expandList = this.mZipExpandList[k]
            // 	if(expandList){
            // 		zipobj = expandList[path]
            // 	}
            // 	if(zipobj == null){//解压
            // 		let zip: JSZip = this.mZipList[k]
        ...
        ResManager.prototype.loadResAsynLocal = function (key, callback, type) {
            this._loadResAsyn(key, 0, callback, type, false);
        };
        //指定远程服务器的资源(mRemotePath)
        ResManager.prototype.loadResAsyn = function (key, callback, type) {
            this._loadResAsyn(key, 0, callback, type, true);
        };
        ResManager.prototype.loadResAsynWithPriority = function (key, priority, callback, type) {
            this._loadResAsyn(key, priority, callback, type, true);
        };
        //先检查versionControl是否初始化
        ResManager.prototype._loadResAsyn = function (key, priority, callback, type, isRemote) {
            if (this.mVersionController != null && this.mbVersionControllerInit == false) {
                this.mbVersionControllerInit = true;
                var self_1 = this;
                this.mVersionController.init().then(function () {
                    self_1._loadResAsynImp(key, priority, callback, type, isRemote);
                });
            }
            else {
                this._loadResAsynImp(key, priority, callback, type, isRemote);
            }
        };
        ResManager.prototype.isAbsolutePath = function (path) {
            return path.indexOf("http://") != -1 || path.indexOf("https://") != -1;
        };
        ResManager.prototype._loadResAsynAbsulotePath = function (key, priority, callback, type, isRemote) {
            ...
            this.pushLoadQueue(key, type, priority);
            this.nextLoadQueue();
        };
        ResManager.prototype._loadResAsynImp = function (key, priority, callback, type, isRemote) {
            TLog.Assert(key != null);
            if (this.isAbsolutePath(key)) {
                this._loadResAsynAbsulotePath(key, priority, callback, type, isRemote);
                return;
            }
            key = key.replace(/\\/g, "/");
            ...
            if (RES.hasRes(key)) {
                ...
                path = this.getFilePathFromLogicKey(path);
                ...
                this.pushLoadQueue(path, type, priority);
                this.nextLoadQueue();
            }
        };
        ResManager.prototype.pushLoadQueue = function (path, type, priority) {
            var newLoadInfo = { path: path, type: type, priority: priority };
            //队列第一位优先级最高
            var insertIndex = this.mLoadQueue.length;
            for (var i = 0; i < this.mLoadQueue.length; i++) {
                var info = this.mLoadQueue[i];
                if (priority > info.priority) {
                    insertIndex = i;
                    break;
                }
            }
            this.mLoadQueue.splice(insertIndex, 0, newLoadInfo);
            //this.mLoadQueue.push()
        };
        ...
        ResManager.prototype.nextLoadQueue = function () {
            while (this.mLoadCount < this.mLoadMaxCount && this.mLoadQueue.length > 0) {
                ...
                if (info == null)
                    break;
                var promise = RES.getResByUrl(info.path, this.onItemLoadSuccess, this, info.type);
                if (promise) {
        ...
        ResManager.prototype.getRes = function (_key) {
            var key = this.getFilePathFromLogicKey(_key);
        ...
        ResManager.prototype.setMaxErrorTimes = function (times) {
            ...
            RES.setMaxRetryTimes(times);
        };
        ResManager.prototype.clearErrorRes = function () {
            this.mErrorResMap = {};
        };
        ResManager.prototype.addZipPacket = function (key, callback) {
            var bExpand = true;
            key = key.replace(/\\/g, "/");
            ...
            var zipCallback = {
                onResItemLoad: function (res) {
                    ...
                    if (zip) {
                        //res.retain();
                        if (bExpand) {
                            var expandZipObjList = zip.file(/.+/); //解压缩zip全部文件
        ...
        // public removeZipExpandCache(key: string): void {
        // 	if(key in this.mZipExpandList){
        // 		delete this.mZipExpandList[key]
        // 	}
        // }
        ResManager.prototype.getZipPacketCount = function () {
            ...
            for (var k in this.mPlainTextZipMap) {
                count++;
            }
            return count;
        };
        /////////////////////////////////////////////////////////////////////////
        //添加明文压缩，实际是json格式，格式：{[path]=content}
        ResManager.prototype.addPlainTextZip = function (key, callback) {
            var bExpand = true;
            key = key.replace(/\\/g, "/");
            var zipJson = this.mPlainTextZipMap[key];
            if (zipJson) {
                if (callback)
                    callback.onZipItemLoad(key, 0);
                return;
            ...
            var zipCallback = {
                onResItemLoad: function (res) {
                    var zipkey = res.getKey();
                    var zipJson = res.getData();
                    if (zipJson) {
                        _this.mPlainTextZipMap[zipkey] = zipJson;
                        if (callback)
                            callback.onZipItemLoad(res.getKey(), 0);
                    }
                    else {
            ...
            this.loadResAsyn(key, zipCallback, core.ResourceType.TYPE_JSON);
        };
        ResManager.prototype.removePlainTextZip = function (key) {
            key = key.replace(/\\/g, "/");
            delete this.mPlainTextZipMap[key];
        };
        /////////////////////////////////////////////////////////////////////////
        //modify:crossOrigin
        ...
        ResManager.prototype.onItemLoadSuccess = function (data, key, fromzip) {
            if (data != null) {
                ...
                key = this.getLogicKeyFromFilePath(key);
                if (this.mRootPath != "" && key.indexOf(this.mRootPath) == 0) {
                    key = key.substring(this.mRootPath.length);
                }
        ...
        ResManager.prototype.isErrorRes = function (key) {
            var times = this.mErrorResMap[key];
            //if(times != null && times >= this.mErrorMaxTryTimes)
            if (times != null && times >= 1)
                return true;
            return false;
        };
        ResManager.prototype.onResByUrlError = function (event) {
            var path = event.resItem.name;
            this.releaseLoadThread();
            ...
            var errorTimes = this.mErrorResMap[key];
            if (errorTimes == null) {
                errorTimes = 0;
            }
            errorTimes = errorTimes + 1;
            this.mErrorResMap[key] = errorTimes;
            //再试一次
            ...
            if (errorTimes < 1) {
                ...
                var type = this.mResExplicitType[key];
                this.pushLoadQueue(path, type, 0);
                this.nextLoadQueue();
            }
            else {
        ...
        //////////////////////////////////////////////////////////////////////////////
        //资源的逻辑路径和物理路径映射,native因为有热更新，文件名做了加上crc32处理 [key.ext]=>[key_crc32.ext]
        ResManager.prototype.initNativeFileMapping = function (key2FileInfo) {
            if (key2FileInfo == null)
                return;
            this.mLogicKey2FilePath = key2FileInfo;
            for (var k in key2FileInfo) {
                var f = key2FileInfo[k];
                this.mFilePath2LogicKey[f] = k;
            }
        };
        ResManager.prototype.getFilePathFromLogicKey = function (key) {
            if (key in this.mLogicKey2FilePath) {
                return this.mLogicKey2FilePath[key];
            }
            return key;
        };
        ResManager.prototype.getLogicKeyFromFilePath = function (fileName) {
            if (fileName in this.mFilePath2LogicKey) {
                return this.mFilePath2LogicKey[fileName];
            }
            return fileName;
        };
        return ResManager;
...
(function (core) {
    ...
    var TextureManager = (function (_super) {
        ...
        TextureManager.prototype.loadTextureAsyn = function (key, callback) {
            this.loadTextureAsynWithPriority(key, 0, callback);
        };
        TextureManager.prototype.loadTextureAsynWithPriority = function (key, priority, callback) {
            key = key.replace(/\\/g, "/");
            ...
            resMgr.loadResAsynWithPriority(key, priority, this, core.ResourceType.TYPE_IMAGE);
        };
        ...
        // private getTextureWebGL(texture:egret.Texture){
        // 	let stage:egret.Stage = Application.getInstance().getStageNode();
        // 	let bitmapData:egret.BitmapData = texture.bitmapData;
        ...
        TextureManager.prototype.addCleanGraphic = function (graphicNode) {
            ...
            if (this.mGraphicCleanList.length > this.mGraphicMaxCount) {
...
(function (core) {
    var ErrorReport = (function (_super) {
        ...
        ErrorReport.prototype.captureError = function (error) {
            ...
            //}
            var errorMsg = error.stack != "" ? error.stack : error.message;
            if (errorMsg == "")
                return;
...
var JsUtil = (function () {
    ...
    JsUtil.arrayRemoveValWithFun = function (list, func) {
        for (var i = 0; i < list.length; i++) {
            var item = list[i];
            if (func(item)) {
                list.splice(i, 1);
    ...
    //删除列表所有相同项
    JsUtil.arrayRemoveAllVal = function (list, val) {
    ...
    //删除所有相同项，通过自定义函数
    JsUtil.arrayRemoveAllValWithFunc = function (list, func) {
        var count = list.length;
        var idx = 0;
        while (count > 0) {
            var item = list[idx];
...
var gui;
(function (gui) {
    var CustomColorNameIndexMap = {};
    function AddCustomColor(colorname, color) {
        CustomColorNameIndexMap[colorname] = color;
    }
    gui.AddCustomColor = AddCustomColor;
    var Color;
    (function (Color) {
        ...
        Color[Color["darkgoldenrod"] = 16737792] = "darkgoldenrod";
    ...
    function GetColorFromName(colorName) {
        ...
        if (colorName in CustomColorNameIndexMap) {
            return CustomColorNameIndexMap[colorName];
        }
...
(function (gui) {
    var GuiManager = (function (_super) {
        ...
        GuiManager.prototype.init = function (rootNode, stage) {
            ...
            this.mEffectLayer = new eui.UILayer;
            ...
            this.mEffectLayer.touchEnabled = false;
            this.mEffectLayer.name = "EffectLayer";
            ...
            this.mUIRootNode.addChild(this.mEffectLayer);
            //注入加载方式：资源和主题
        ...
        GuiManager.prototype.getChildFromPath = function (path) {
            ...
            if (pathlist.length == 0)
                return null;
            var node = this.getChildFromPathImp(this.mEffectLayer, pathlist);
            if (node != null)
                return node;
            node = this.getChildFromPathImp(this.mModalLayer, pathlist);
            if (node != null)
                return node;
            node = this.getChildFromPathImp(this.mTopLayer, pathlist);
            if (node != null)
                return node;
        ...
        GuiManager.prototype.startDriveTouch = function () {
            ...
            if (event.isDriveBegin()) {
                ...
                this.mEffectLayer.addChild(this.mDriveDisplayerObject);
            }
        };
        GuiManager.prototype.stopDriveTouch = function (x, y, touchPointID) {
            ...
            this.mEffectLayer.removeChild(this.mDriveDisplayerObject);
        ...
        GuiManager.prototype.initGuiTouchEvent = function () {
            ...
            egret.sys.TouchHandler.prototype.onTouchEnd = function (x, y, touchPointID) {
                ...
                var target = null;
                if (_this.mTouchId == touchPointID) {
                    target = stageObj.$hitTest(x, y);
                }
                ...
                if (_this.mTouchId == touchPointID && _this.mDriveTargetSaveData != null) {
            ...
            //override eui.Image
            {
                ...
                eui.Image.prototype["onVisibleChange"] = function () {
                    ...
                    if (this.isVisibleOnStage()) {
                        ...
                        if (this.sourceChanged || (texture && (texture.$bitmapData == null || texture.$bitmapData.webGLTexture == null))) {
                            this.parseSource();
                        }
                    }
                    else {
...
(function (gui) {
    ...
    var ActorView = (function (_super) {
        ...
        // public getActor():map.MovableSprite{
        // 	return this.mActor;
        // }
    ...
    var AnimBox = (function (_super) {
        ...
        AnimBox.prototype.setAnimName = function (animName) {
            if (animName == null || animName == "")
                return;
            var animSet = gui.AnimSet.getInstance();
            var animInfo = animSet.getAnimInfo(animName);
            if (animInfo == null) {
                return;
            }
            //如果没有加入imageset，则添加
            ...
            this.m_intervalTime = this.m_explictIntervalTime == 0 ? animInfo.interval : this.m_explictIntervalTime;
        ...
        AnimBox.prototype.reset = function () {
            this.m_frameIndex = -1;
            this.m_AnimChanged = false;
        };
        AnimBox.prototype.setLoop = function (loop, loopFixed) {
            if (loopFixed === void 0) { loopFixed = false; }
            this.m_bLoop = loop;
            this.m_animLoopFixed = loopFixed;
        };
        AnimBox.prototype.setAnimInterval = function (millisecond) {
            if (millisecond < 0)
                millisecond = 100;
            this.m_explictIntervalTime = millisecond;
        ...
        AnimBox.prototype.onTick = function () {
            ...
            if (this.m_frameIndex == -1) {
                this.m_frameIndex = !this.m_bReverse ? 0 : this.m_AnimInfo.count;
            ...
            while (this.m_intervalCurrentTime >= this.m_intervalTime) {
                ...
                if (!this.m_bReverse) {
                    ...
                    if (this.m_frameIndex > this.m_AnimInfo.count - 1) {
                        loopFinish = true;
                        this.m_frameIndex = this.m_animLoopFixed ? this.m_AnimInfo.count - 1 : 0;
                    }
                }
                else {
                    this.m_frameIndex--;
                    if (this.m_frameIndex < 0) {
                        loopFinish = true;
                        this.m_frameIndex = this.m_animLoopFixed ? 0 : this.m_AnimInfo.count - 1;
                    }
                }
                this.m_AnimChanged = true;
                if (loopFinish) {
    ...
    var BatchImage = (function (_super) {
        ...
        BatchImage.prototype.drawNumberString = function (image_prefix, strNumber, targetX, targetY, spaceX) {
            ...
            for (var s = 0; s < strNumber.length; s++) {
                ...
                if (imageInfo) {
                    targetX += imageInfo.sourceW + spaceX;
                    imageW = imageW + imageInfo.sourceW;
                }
            }
            return imageW;
        };
...
(function (gui) {
    ...
    var Button = (function (_super) {
        ...
        Button.prototype.smallButton = function () {
            ...
            for (var i = 0; i < this.movableCompList.length; i++) {
                var comp = this.movableCompList[i];
                comp.scaleX = 0.9;
                comp.scaleY = 0.9;
            }
        };
        ...
        Button.prototype.setActivatedComp = function (compName, bActivate) {
            var self = this;
            var comp = self[compName];
            var index = this.movableCompList.indexOf(comp);
            if (index != -1)
                return;
            if (bActivate == false) {
                this.movableCompList.splice(index, 1);
            }
            else {
                this.movableCompList.splice(this.movableCompList.length, 0, comp);
            }
        };
        return Button;
    }(eui.Button));
...
var gui;
(function (gui) {
    var DBAnimBox = (function (_super) {
        __extends(DBAnimBox, _super);
        function DBAnimBox() {
            var _this = _super.call(this) || this;
            _this.mAnimName = "";
            _this.mActionName = "";
            _this.mAnimSpeed = 1;
            _this.mLoopCount = -1;
            _this.mAnimChanged = false;
            _this.mbPause = true;
            return _this;
        }
        Object.defineProperty(DBAnimBox.prototype, "animName", {
            get: function () {
            ...
            set: function (animName) {
                if (animName == "" || animName == null)
                    return;
                if (animName != this.mAnimName) {
                    this.mAnimName = animName;
                    if (this.mDBResource != null) {
                        this.mDBResource.unload();
                        this.mDBResource = null;
                    }
                    this._clearArmature();
                    if (this.stage != null) {
                        this._loadResouce();
        ...
        Object.defineProperty(DBAnimBox.prototype, "actionName", {
            get: function () {
                return this.mActionName;
            },
            //loop 动画需要播放的次数。 [-1: 使用动画数据默认值, 0: 无限循环播放, [1~N]: 循环播放 N 次]
            set: function (actionId) {
                this.mActionName = actionId;
                this.mAnimChanged = true;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(DBAnimBox.prototype, "loopCount", {
            get: function () {
        ...
        Object.defineProperty(DBAnimBox.prototype, "animSpeed", {
            get: function () {
        ...
        DBAnimBox.prototype.play = function () {
            this.mbPause = false;
            this.mAnimChanged = true;
        };
        DBAnimBox.prototype.pause = function () {
            this.mbPause = true;
            this.mAnimChanged = true;
        };
        DBAnimBox.prototype.$onAddToStage = function (stage, nestLevel) {
            _super.prototype.$onAddToStage.call(this, stage, nestLevel);
            gui.GuiManager.getInstance().addTickCallback(this);
            this._loadResouce();
        };
        DBAnimBox.prototype.$onRemoveFromStage = function () {
            _super.prototype.$onRemoveFromStage.call(this);
            gui.GuiManager.getInstance().removeTickCallback(this);
            this._clearArmature();
            this._unloadResource();
        };
        DBAnimBox.prototype.updateDisplayList = function (unscaledWidth, unscaledHeight) {
            if (this._armatureDisplay) {
                this._armatureDisplay.x = unscaledWidth / 2;
                this._armatureDisplay.y = unscaledHeight / 2;
            }
        };
        DBAnimBox.prototype.onTick = function () {
            if (this.mDBResource == null || this.mDBResource.isLoaded() == false)
                return;
            if (this.mbPause) {
        ...
        /////////////////////////////////////////////////////////////////////////////////
        DBAnimBox.prototype._loadResouce = function () {
            if (this.mDBResource == null) {
                this.mDBResource = gui.DBAnimSet.getInstance().getDBAnimResource(this.mAnimName);
                if (this.mDBResource != null)
                    this.mDBResource.load();
            }
        };
        DBAnimBox.prototype._unloadResource = function () {
            if (this.mDBResource != null) {
                this.mDBResource.unload();
                this.mDBResource = null;
            }
        };
        DBAnimBox.prototype._updateAnimation = function () {
            if (this._armatureDisplay == null)
                return;
            var actionId = this.mActionName;
            if (actionId == "" || actionId == null) {
                this._armatureDisplay.animation.play(null, this.loopCount);
            }
            else {
                this._armatureDisplay.animation.play(actionId, this.loopCount);
            }
            this._armatureDisplay.animation.timeScale = this.animSpeed;
        };
        DBAnimBox.prototype._createArmature = function () {
            var factory = dragonBones.EgretFactory.factory;
            var modelName = this.mAnimName;
            var dragonBonesData = factory.getDragonBonesData(modelName);
            var armatureName = modelName;
            if (dragonBonesData != null && dragonBonesData.armatureNames.length == 1)
                armatureName = dragonBonesData.armatureNames[0];
            this._armatureDisplay = factory.buildArmatureDisplay(armatureName, modelName);
            if (this._armatureDisplay == null) {
                TLog.Error("DBAnimBox._createArmature%s", this.mAnimName);
                return;
            }
            this._armatureDisplay.addEventListener(dragonBones.EventObject.LOOP_COMPLETE, this.onAnimationEvent, this);
            this._armatureDisplay.x = this.width / 2;
            this._armatureDisplay.y = this.height / 2;
            this.mAnimChanged = true;
            this.addChild(this._armatureDisplay);
        };
        DBAnimBox.prototype._clearArmature = function () {
            if (this._armatureDisplay) {
        ...
        DBAnimBox.prototype.onAnimationEvent = function (event) {
            if (event.type == dragonBones.EventObject.LOOP_COMPLETE) {
                var event_4 = new gui.GUIEvent(DBAnimBox.AnimEndEvent, this);
                this.dispatchEvent(event_4);
            }
        };
        DBAnimBox.AnimEndEvent = "AnimEndEvent";
        return DBAnimBox;
    }(eui.Component));
    gui.DBAnimBox = DBAnimBox;
    __reflect(DBAnimBox.prototype, "gui.DBAnimBox", ["gui.GuiTickCallback"]);
})(gui || (gui = {}));
var gui;
(function (gui) {
    //1.自动九宫格
...
(function (gui) {
    ...
    var RichDisplayer = (function (_super) {
        ...
        function RichDisplayer() {
            ...
            _this.mbDisplayChanged = false;
            _this.mRowDistance = 0;
            _this.mCacheCtrlList = {};
            _this.mbShowLast = false;
            _this.mbShowFirst = false;
            _this.mTempXmlNodeList = [];
            _this.mCurrentXmlId = -1;
            _this.mCacheWidth = 0;
            _this.mCacheHeight = 0;
            return _this;
        }
        RichDisplayer.prototype.translateWord = function (text) {
            ...
            for (var i = 0; i < length; i++) {
                ...
                if (i % 2 == 1 && i != length - 1) {
                    if (str != "") {
                        var event_5 = new gui.GUITranslateWordEvent(RichDisplayer.RichDisplayerTranslateEvent, this);
                        event_5.setTranslateWord(str);
                        this.dispatchEvent(event_5);
                        var transStr = event_5.getTranslateWord();
                        if (transStr == "") {
                            //strList[i] = transStr;
                            return text;
                        }
        ...
        RichDisplayer.prototype.showFirstRow = function (bFirst) {
            if (bFirst == null)
                bFirst = true;
            this.mbShowFirst = bFirst;
        };
        RichDisplayer.prototype.showLastRow = function (bLast) {
            if (bLast == null)
                bLast = true;
            this.mbShowLast = bLast;
        };
        RichDisplayer.prototype._addXmlNodeImp = function () {
            var _this = this;
            var _loop_1 = function (i) {
                var info = this_1.mTempXmlNodeList[i];
                var xml = info.content;
                var xmlid = info.xmlid;
        ...
        RichDisplayer.prototype._addXmlStringImp = function (xmlid, xmlStr) {
            var _this = this;
        ...
        RichDisplayer.prototype.addXmlString = function (xmlStr) {
            if (xmlStr == "")
                return;
            gui.RichDisplayer.SEED_ID = gui.RichDisplayer.SEED_ID + 1;
            var xmlId = gui.RichDisplayer.SEED_ID;
            this.mTempXmlList.push({ content: xmlStr, xmlid: xmlId });
        ...
        RichDisplayer.prototype.addXmlNode = function (xmlNode) {
            ...
            gui.RichDisplayer.SEED_ID = gui.RichDisplayer.SEED_ID + 1;
            var xmlId = gui.RichDisplayer.SEED_ID;
            this.mTempXmlNodeList.push({ content: xmlNode, xmlid: xmlId });
            this.mContentChanged = true;
            this.invalidateDisplayList();
            return xmlId;
        };
        //移除XML
        RichDisplayer.prototype.removeXmlById = function (xmlid) {
            var _this = this;
            //删除临时信息
            JsUtil.arrayRemoveValWithFun(this.mTempXmlList, function (tempInfo) {
                return tempInfo.xmlid == xmlid;
            });
            JsUtil.arrayRemoveValWithFun(this.mTempXmlNodeList, function (tempInfo) {
                return tempInfo.xmlid == xmlid;
            });
            //删除相关LogicInfo
            JsUtil.arrayRemoveAllValWithFunc(this.mLogicInfoList, function (logicInfo) {
                return logicInfo.xmlid == xmlid;
            });
            //删除相关RowInfo
            JsUtil.arrayRemoveAllValWithFunc(this.mRowInfoList, function (rowInfo) {
                //return item.xmlid == xmlid;
                if (rowInfo.xmlid == xmlid) {
        ...
        RichDisplayer.prototype.getCurrentRow = function () {
            ...
            if (rowInfo == null) {
                TLog.Assert(this.mCurrentXmlId != -1, "getCurrentRow");
                rowInfo = new RowInfo();
                rowInfo.xmlid = this.mCurrentXmlId;
        ...
        RichDisplayer.prototype.insertImage = function (logicInfo) {
            ...
            if (imageInfo == null || imageInfo.w > this.mCacheWidth) {
                return;
            }
            var rowInfo = this.getCurrentRow();
            if (rowInfo.contentW + imageInfo.w > this.mCacheWidth) {
                this.finishCurrentRow();
                rowInfo = this.getCurrentRow();
            }
            this.addPosInfo(logicInfo, imageInfo.sourceW, imageInfo.sourceH);
        };
        RichDisplayer.prototype.insertAnim = function (logicInfo) {
            var animInfo = gui.AnimSet.getInstance().getAnimInfo(logicInfo.name);
            if (animInfo == null || animInfo.w > this.mCacheWidth) {
                return;
            }
            var rowInfo = this.getCurrentRow();
            if (rowInfo.contentW + animInfo.w > this.mCacheWidth) {
                this.finishCurrentRow();
                rowInfo = this.getCurrentRow();
            }
        ...
        RichDisplayer.prototype.insertText = function (logicInfo) {
            ...
            //整行显示
            var rowInfo = this.getCurrentRow();
            var strW = egret.sys.measureText(logicInfo.text, fontInfo.fontName, fontInfo.fontSize, fontInfo.isBold(), fontInfo.isItalic());
            if (rowInfo.contentW + strW <= displayW) {
                lastPos = logicInfo.text.length - 1;
                curTextLen = strW;
            }
            else {
                for (var i = 0; i < logicInfo.text.length; i++) {
                    var str = logicInfo.text[i];
                    var strW_1 = egret.sys.measureText(str, fontInfo.fontName, fontInfo.fontSize, fontInfo.isBold(), fontInfo.isItalic());
                    var rowInfo_1 = this.getCurrentRow();
                    if (rowInfo_1.contentW + curTextLen + strW_1 <= displayW) {
                        lastPos = i;
                        curTextLen += strW_1;
                    }
                    else {
        ...
        RichDisplayer.prototype.clearAllCtrl = function () {
            var _this = this;
            if (this.mRowInfoList.length > 0) {
        ...
        RichDisplayer.prototype.refreshLogicShow = function (sizeChange) {
            sizeChange = !!sizeChange;
            if (this.mContentChanged == false && sizeChange == false)
                return;
            this.mContentChanged = false;
            this.mbDisplayChanged = true;
            this.mCacheWidth = this.width;
            this.mCacheHeight = this.height;
            if (this.mTempXmlList.length > 0) {
                for (var i = 0; i < this.mTempXmlList.length; i++) {
                    var info = this.mTempXmlList[i];
                    this._addXmlStringImp(info.xmlid, info.content);
                }
                this.mTempXmlList = [];
            }
            ...
            this.mCurrentXmlId = -1;
            if (this.mLogicInfoList.length > 0) {
                //重新排位当前布局
                var displayW = this.mCacheWidth;
                var displayH = this.mCacheHeight;
                for (var i = 0; i < this.mLogicInfoList.length; i++) {
                    var logicInfo = this.mLogicInfoList[i];
                    this.mCurrentXmlId = logicInfo.xmlid;
                    if (logicInfo.isnew == true || sizeChange) {
                        logicInfo.isnew = false;
        ...
        RichDisplayer.prototype.updateDisplayList = function (unscaledWidth, unscaledHeight) {
            do {
                if (unscaledWidth == 0 || unscaledHeight == 0) {
                    TLog.Error("RichDisplayer::refreshShow unscaledWidth == 0 || unscaledHeight == 0");
                    break;
                }
                // if (!this.visible) {
                // 	break;
                ...
                if (this.mCacheWidth != unscaledWidth || this.mCacheHeight != unscaledHeight) {
                    //this.mbDisplayChanged = true;
                    sizeChange = true;
                    this.mCacheWidth = unscaledWidth;
                    this.mCacheHeight = unscaledHeight;
                }
                //刷新逻辑排版
                this.refreshLogicShow(sizeChange);
                if (this.mbDisplayChanged == true) {
                    this.mbDisplayChanged = false;
                    //刷新实际排版
                    var logicStartX = 0;
                    var logicStartY = 0;
                    ...
                    if ((this.mAlignFlag & gui.Flag.H_CENTER) == gui.Flag.H_CENTER) {
                        logicStartX = (this.mCacheWidth - logicW) / 2;
                    }
                    else if ((this.mAlignFlag & gui.Flag.RIGHT) == gui.Flag.RIGHT) {
                        logicStartX = this.mCacheWidth - logicW;
                    }
                    if ((this.mAlignFlag & gui.Flag.V_CENTER) == gui.Flag.V_CENTER) {
                        logicStartY = (this.mCacheHeight - logicH) / 2;
                    }
            ...
            else if (this.mbShowLast) {
                //移动Scroller过程中，不设置滚动
                var curScrollV = this.scrollV;
                var bottomScrollV = this.contentHeight - this.mCacheHeight;
                if (bottomScrollV < 0) {
                    bottomScrollV = 0;
                }
        ...
        RichDisplayer.prototype.onRdTouchTapCapture = function (event) {
            ...
            if (logicInfo && logicInfo.link != "") {
                var event_6 = new gui.GUIHyperlinkEvent(RichDisplayer.RichDisplayerLinkCmdEvent, this);
                event_6.setHyperlink(logicInfo.link);
                this.dispatchEvent(event_6);
            }
        };
        RichDisplayer.SEED_ID = 100;
...
(function (gui) {
    ...
    var AnimSet = (function (_super) {
        ...
        AnimSet.prototype.getAnimInfo = function (name) {
            var animInfo = this.mInfoList[name];
            if (animInfo == null || animInfo.count <= 0) {
                var imageSet = gui.ImageSet.getInstance();
                var count = 0;
                var sourceW = 0;
                var sourceH = 0;
                for (var i = 1; i <= gui.AnimBox.MaxFrameCount; i++) {
                    var frameImageName = String.format("%s_%02d", name, i);
                    var info = imageSet.getImageInfo(frameImageName);
                    if (info == null) {
                        break;
                    }
                    if (sourceW == 0) {
                ...
                if (count > 0) {
                    this.insertInfo(name, sourceW, sourceH, count, AnimSet.DefaultAnimInterval);
                    animInfo = this.getAnimInfo(name);
                }
                else {
                    TLog.Error("AnimBox::SetName %s Error", name);
                    return;
                }
            }
            return animInfo;
        ...
        AnimSet.DefaultAnimInterval = 100;
        return AnimSet;
    }(TClass));
    gui.AnimSet = AnimSet;
...
(function (gui) {
    var DBAnimLoadState;
    (function (DBAnimLoadState) {
        DBAnimLoadState[DBAnimLoadState["eLoaded"] = 0] = "eLoaded";
        DBAnimLoadState[DBAnimLoadState["eUnLoaded"] = 1] = "eUnLoaded";
        DBAnimLoadState[DBAnimLoadState["eLoading"] = 2] = "eLoading";
    })(DBAnimLoadState = gui.DBAnimLoadState || (gui.DBAnimLoadState = {}));
    var DBAnimResource = (function (_super) {
        __extends(DBAnimResource, _super);
        function DBAnimResource() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        //子类复写 初始化函数
        DBAnimResource.prototype.initObj = function () {
            var params = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                params[_i] = arguments[_i];
            }
            ...
            var path = params[1];
            this.modelJsonPath = path.concat("/" + modelName + "_ske.dbbin");
            this.texturePath = path.concat("/" + modelName + "_tex.png");
            this.textureJsonPath = path.concat("/" + modelName + "_tex.json");
            this.modelName = modelName;
            this.mResRefCount = 0;
            this.mLoadState = DBAnimLoadState.eUnLoaded;
        };
        //子类复写 析构函数
        DBAnimResource.prototype.destory = function () {
        };
        DBAnimResource.prototype.isLoaded = function () {
            return this.mLoadState == DBAnimLoadState.eLoaded;
        };
        DBAnimResource.prototype.isLoading = function () {
            return this.mLoadState == DBAnimLoadState.eLoading;
        };
        DBAnimResource.prototype.isUnLoaded = function () {
            return this.mLoadState == DBAnimLoadState.eUnLoaded;
        };
        DBAnimResource.prototype.load = function () {
            this.mResRefCount++;
            if (this.mResRefCount == 1) {
                this.mLoadState = DBAnimLoadState.eLoading;
                this._loadImp();
            }
            return this.mLoadState == DBAnimLoadState.eLoaded;
        };
        DBAnimResource.prototype.unload = function () {
            // if (this.isUnLoaded() || this.isUnLoading())
            // 	return;
            TLog.Assert(this.mResRefCount > 0);
            this.mResRefCount--;
        ...
        ///////////////////////////////////////////////////////////////////////////
        //加载实现
        DBAnimResource.prototype._loadImp = function () {
            var resMgr = core.ResManager.getInstance();
        ...
        DBAnimResource.prototype._unloadImp = function () {
            var factory = dragonBones.EgretFactory.factory;
            if (this.dragonBonesData) {
                factory.removeDragonBonesData(this.modelName);
                this.dragonBonesData = null;
            }
            if (this.textureAtlasData) {
                factory.removeTextureAtlasData(this.modelName);
        ...
        DBAnimResource.prototype._cancelLoadImp = function () {
            var resMgr = core.ResManager.getInstance();
        ...
        DBAnimResource.prototype.onResItemLoad = function (res) {
            if (res.getKey() == this.modelJsonPath) {
                this.tempModelJsonRes = res;
                res.retain();
            }
            else if (res.getKey() == this.textureJsonPath) {
                this.tempTextureJsonRes = res;
                res.retain();
            }
            this._onLoadFinish();
        };
        DBAnimResource.prototype.onResItemError = function (key) {
        };
        DBAnimResource.prototype.onAsynTextureSucceed = function (key, texture, textureRes) {
        ...
        DBAnimResource.prototype.releaseTempRes = function () {
            if (this.tempTextureJsonRes) {
                this.tempTextureJsonRes.release();
                this.tempTextureJsonRes = null;
            }
            if (this.tempModelJsonRes) {
                this.tempModelJsonRes.release();
                this.tempModelJsonRes = null;
            }
        };
        DBAnimResource.prototype._onLoadFinish = function () {
            if (this.tempTextureJsonRes &&
                this.textureRes && this.tempModelJsonRes) {
                var factory = dragonBones.EgretFactory.factory;
                this.textureAtlasData = factory.parseTextureAtlasData(this.tempTextureJsonRes.getData(), this.textureRes.getData(), this.modelName);
                this.dragonBonesData = factory.parseDragonBonesData(this.tempModelJsonRes.getData(), this.modelName);
                TLog.Assert(this.dragonBonesData.name == this.modelName, "DBAnimResource name:%s error", this.dragonBonesData.name);
                this.releaseTempRes();
                this.mLoadState = DBAnimLoadState.eLoaded;
            }
        };
        return DBAnimResource;
    }(TClass));
    gui.DBAnimResource = DBAnimResource;
    __reflect(DBAnimResource.prototype, "gui.DBAnimResource", ["core.ResItemCallback", "core.TextureCallback"]);
})(gui || (gui = {}));
var gui;
(function (gui) {
    var DBAnimInfo = (function (_super) {
        __extends(DBAnimInfo, _super);
        function DBAnimInfo() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        return DBAnimInfo;
    }(TClass));
    gui.DBAnimInfo = DBAnimInfo;
    __reflect(DBAnimInfo.prototype, "gui.DBAnimInfo");
    var DBAnimSet = (function (_super) {
        __extends(DBAnimSet, _super);
        function DBAnimSet() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        //子类复写 初始化函数
        DBAnimSet.prototype.initObj = function () {
            var params = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                params[_i] = arguments[_i];
            }
        ...
        //子类复写 析构函数
        DBAnimSet.prototype.destory = function () {
        };
        DBAnimSet.prototype.insertInfo = function (modelName, path) {
            var info = DBAnimInfo.newObj();
            info.path = path;
            info.modelName = modelName;
            this.mInfoList[modelName] = info;
            return true;
        };
        DBAnimSet.prototype.getDBAnimInfo = function (name) {
            return this.mInfoList[name];
        };
        DBAnimSet.prototype.getDBAnimResource = function (name) {
            var info = this.getDBAnimInfo(name);
            if (info == null) {
                return null;
            }
            var res = this.mResourceList[name];
            if (res == null) {
                res = gui.DBAnimResource.newObj(info.modelName, info.path);
                this.mResourceList[name] = res;
            }
            return res;
        };
        return DBAnimSet;
    }(TClass));
    gui.DBAnimSet = DBAnimSet;
    __reflect(DBAnimSet.prototype, "gui.DBAnimSet");
})(gui || (gui = {}));
var gui;
(function (gui) {
...
(function (gui) {
    ...
    var ImageSet = (function (_super) {
        ...
        ImageSet.prototype.dumpImage = function () {
            var file2InfoList = {};
            for (var k in this.mInfoList) {
                var v = this.mInfoList[k];
                if (v.baseTexture != null) {
                    if (file2InfoList[v.fileName] == null) {
                        file2InfoList[v.fileName] = [];
                    }
                    file2InfoList[v.fileName].push(k);
                }
            }
            TLog.Debug("==============ImageSet.dumpImage==============");
            for (var k_1 in file2InfoList) {
                var list = file2InfoList[k_1];
                TLog.Debug("file:%s, subText:%s", k_1, list.join(","));
            }
        };
        return ImageSet;
    }(TClass));
...
(function (map) {
    ...
    var MapManager = (function (_super) {
        ...
        MapManager.prototype.onLoadMapImp = function () {
            ...
            if (mapData.tileWidth > 256)
                map.EyeGridSize = mapData.tileWidth;
            else
                map.EyeGridSize = 256;
            ...
            var cellYCount = map.LogicBlock.getCellY(mapH);
            ...
            //更新下camera
            this.getCamera().onMapLoadFinish();
            this.mMapData.clear();
            this.mMapData = null;
            this.onLoadMapFinish();
        };
        MapManager.prototype.onLoadMapFinish = function () {
            ...
            if (this.m_loadingMapPathList.length > 0) {
                ...
                this.loadMap(path, this.mUserData);
            }
            else {
        ...
        //===============================地图资源===============================
        MapManager.prototype.setCacheTileImage = function (bCache) {
            this.mbCacheTileImage = bCache;
        };
        MapManager.prototype.isCacheTileImage = function () {
            return this.mbCacheTileImage;
        };
        return MapManager;
    }(core.EventSet));
...
(function (core) {
    ...
    var HttpClient = (function (_super) {
        ...
        HttpClient.prototype.request = function (url, params, method, callback, userData) {
        ...
        HttpClient.prototype.send = function (url, callback, userData) {
            this.request(url, null, egret.HttpMethod.GET, callback, userData);
        };
        HttpClient.prototype.post = function (url, params, callback, userData) {
            this.request(url, params, egret.HttpMethod.POST, callback, userData);
        };
...
(function (map) {
    ...
    map.TWalkLine = TWalkLine;
    __reflect(TWalkLine.prototype, "map.TWalkLine");
    var LogicPath = (function (_super) {
        ...
        LogicPath.prototype.SetTimeline = function (time) {
            this.m_iCurrentTime = time;
        ...
        LogicPath.prototype.GetCurrentPathIndex = function () {
            return this.m_iCurLine;
        };
        LogicPath.prototype.GetCurrentPathThousand = function () {
            return this.m_iCurThousand;
        };
        LogicPath.prototype.GetPathNum = function () {
            return this.m_iMaxLine;
        };
        LogicPath.prototype.GetPathList = function () {
            return this.m_pLine;
        };
        LogicPath.prototype.GetEndX = function () {
            return this.m_ptEnd.x;
        };
        LogicPath.prototype.GetEndY = function () {
            return this.m_ptEnd.y;
        };
...
(function (map) {
    ...
    var PathMgr = (function (_super) {
        ...
        PathMgr.prototype.TryNoBlockPath = function (from, to, ignoreBlock, outValue) {
            ...
            ptTrueStart.y = map.LogicBlock.getCellY(from.y);
            ptTrueEnd.x = map.LogicBlock.getCellX(to.x);
            ptTrueEnd.y = map.LogicBlock.getCellY(to.y);
            outValue.ptTrueStart = ptTrueStart;
            outValue.ptTrueEnd = ptTrueEnd;
            outValue.bNoBlock = false;
            if (ignoreBlock) {
...
// 		let myResMgr:core.ResManager = core.ResManager.getInstance()
// 		let _getResByUrl = Resource.prototype.getResByUrl
// 		Resource.prototype.getResByUrl = function(key: string, compFunc?: GetResAsyncCallback, thisObject?: any, type: string = ""):Promise<any> | void {
// 			return _getResByUrl.call(this, key, compFunc, thisObject, type).catch(e=>{
...
(function (egret) {
    ...
    (function (override) {
        function _init() {
            ...
            // {
            //     //优化文本纹理，延迟一段时间才清理
            //     let superClass = egret.DisplayObject;
            //     let textureMgr:core.TextureManager = core.TextureManager.getInstance();
            //     let _onAddToStage = TextField.prototype.$onAddToStage
            //     TextField.prototype.$onAddToStage = function(stage: Stage, nestLevel: number):void {
            //         _onAddToStage.call(this, stage, nestLevel);
            //         textureMgr.removeCleanTextNode(this.textNode);
            //     }
            //     let _onRemoveFromStage = TextField.prototype.$onRemoveFromStage
            //     TextField.prototype.$onRemoveFromStage = function():void {
            ...
            //         if (this.textNode) {
            //             //this.textNode.clean();
            //             textureMgr.addCleanTextNode(this.textNode);
            ...
            // }
            {
                ...
                // let textureMgr:core.TextureManager = core.TextureManager.getInstance();
                // let _onRemoveFromStage = Graphics.prototype.$onRemoveFromStage
                // Graphics.prototype.$onRemoveFromStage = function():void {
                //     if (this.$renderNode) {
                //         textureMgr.addCleanGraphic(this);
                //     }
                //     if (egret.nativeRender) {
                ...
                // }
                //性能考虑，不检查点击
                // Graphics.prototype.$hitTest = function(stageX: number, stageY: number):DisplayObject {
                //     return null;
                // }
            }
            {
...
(function (map) {
    ...
    var SpriteMovEvent = (function (_super) {
        ...
        SpriteMovEvent.prototype.createPath = function (num) {
            this.pathList = [];
        };
        SpriteMovEvent.prototype.setPathXY = function (index, x, y) {
            this.pathList[index] = { x: x, y: y };
        };
        SpriteMovEvent.prototype.getPathList = function () {
...
(function (core) {
    ...
    var NetWorkResult = (function (_super) {
        ...
        NetWorkResult.prototype.reset = function () {
            this.state = 0;
            this.code = 0;
            this.buffer = null;
        };
    ...
    var NetWork = (function (_super) {
        ...
        NetWork.prototype.connect = function (server, port) {
            ...
            //if(isIp4 == false ){//微信要用域名
            //	protocol = "wss://"
            //}
            //this.socket.connectByUrl(protocol + server + ":" + port);
            var fullConnectUrl = "";
            var index = server.indexOf("ws://"); //如果server里直接指定协议 ws://或wss://
            if (index == 0) {
                fullConnectUrl = server + ":" + port;
            }
            else {
                var index_1 = server.indexOf("wss://"); //如果server里直接指定协议 ws://或wss://
                if (index_1 == 0) {
                    fullConnectUrl = server + ":" + port;
                }
                else {
                    ...
                    fullConnectUrl = protocol + server + ":" + port;
                }
            }
            this.socket.connectByUrl(fullConnectUrl);
            this.mClosing = false;
        ...
        NetWork.prototype.onSocketOpen = function () {
            var result = this.getNetWorkResultFromCache();
        ...
        NetWork.prototype.getNetWorkResultFromCache = function () {
            var result = null;
            if (this.mNetWorkCacheList.length > 0) {
                result = this.mNetWorkCacheList.pop();
            }
            else {
                result = NetWorkResult.newObj();
            }
            return result;
        };
        NetWork.prototype.recycleNetWorkResult = function (network) {
            network.reset();
            this.mNetWorkCacheList.push(network);
        };
        ...
        NetWork.prototype.onUpdate = function () {
            if (this.mRecvResultList.length != 0) {
                for (var _i = 0, _a = this.mRecvResultList; _i < _a.length; _i++) {
                    ...
                    this.recycleNetWorkResult(result);
                    //result.deleteObj();
                }
...
(function (map) {
    var Camera = (function (_super) {
        ...
        function Camera(tileMap) {
            ...
            _this.mMapUIContainer = new egret.DisplayObjectContainer;
            _this.mMapUIContainer.name = "mapui";
            _this.mContainer.addChild(_this.mMapUIContainer);
            _this.mMapUILayer = new eui.UILayer;
            _this.mMapUILayer.touchEnabled = false;
            _this.mMapUILayer.name = "MapUILayer";
            _this.mMapUIContainer.addChild(_this.mMapUILayer);
        ...
        Camera.prototype.onMapLoadFinish = function () {
            this.setViewChanged(true);
            this.mTileMap.updateCameraView();
            this._updateCameraInStage();
        };
        Camera.prototype._updateCameraInStage = function () {
            if (this.stage == null)
                return;
            if (this.mCenterInStage) {
                ...
                if (stageWidth > mapW) {
                    this.x = (stageWidth - mapW) / 2;
                }
                else {
                    this.x = 0;
                }
                if (stageHeight > mapH) {
                    this.y = (stageHeight - mapH) / 2;
                }
                else {
                    this.y = 0;
                }
        ...
        //地图在屏幕中间
        Camera.prototype.setCenterInStage = function (b) {
            this.mCenterInStage = b;
            this._updateCameraInStage();
        };
        Camera.prototype.isCenterInStage = function () {
            return this.mCenterInStage;
        };
        ...
        Camera.prototype.adjustViewCenter = function () {
            ...
            this.mMapUIContainer.x = this.mViewRect.x;
            this.mMapUIContainer.y = this.mViewRect.y;
        ...
        Camera.prototype._setScreenImageImp = function (imagePath, image, parent, index) {
            if (imagePath == "" || imagePath == null) {
                ...
                parent.addChildAt(image, index || 0);
                var textureMgr = core.TextureManager.getInstance();
                textureMgr.loadTextureAsyn(imagePath, callback);
            }
        };
        Camera.prototype.setBgImage = function (imagePath, index) {
            index = index == null ? 0 : index;
            var image = this.getBgImage(index);
            this._setScreenImageImp(imagePath, image, this.mBScreenContainer);
            return image;
        };
        ...
        Camera.prototype.getBgImage = function (index) {
            var maxIndex = this.mBgImage.length - 1;
            if (index > maxIndex) {
                maxIndex = index;
            }
            for (var i = 0; i <= maxIndex; i++) {
                var image = this.mBgImage[i];
                if (image == null) {
                    this.mBgImage[i] = null;
                }
            }
            if (this.mBgImage[index] == null) {
                this.mBgImage[index] = new egret.Bitmap;
            }
            return this.mBgImage[index];
        };
        Camera.prototype.onLayersChange = function () {
            ...
            //MapUI在MapLayer上面
            if (index != -1) {
                this.mContainer.setChildIndex(this.mMapUIContainer, index + 1);
                this.mContainer.setChildIndex(this.mBScreenContainer, index + 2);
                if (this.mBgColorLayer.parent) {
                    this.mContainer.setChildIndex(this.mBgColorLayer, index + 2);
                }
            }
            else {
                this.mContainer.setChildIndex(this.mMapUIContainer, 0);
                this.mContainer.setChildIndex(this.mBScreenContainer, 1);
                if (this.mBgColorLayer.parent) {
                    this.mContainer.setChildIndex(this.mBgColorLayer, 1);
                }
            }
            //从上往下搜索
            index = -1;
        ...
        Camera.prototype.getMapUILayer = function () {
            return this.mMapUILayer;
        };
    ...
    var MapTile = (function (_super) {
        ...
        MapTile.prototype.onTileFound = function (layer) {
            ...
            if (path != "") {
                this.mPath = path;
                var textureMgr = core.TextureManager.getInstance();
                if (this.mTextureRes == null) {
                    this.mMapMgr.addLoadingTileImage(this.mPath);
                    textureMgr.loadTextureAsynWithPriority(path, core.ResourcePriority.Normal, this);
                }
                else {
                    this.mImage.texture = this.mTextureRes.getData(); //显示图片
                }
            }
        };
        ...
        MapTile.prototype.onAsynTextureSucceed = function (key, texture, res) {
            this.mImage.texture = texture; //显示图片
            if (this.mMapMgr.isCacheTileImage() && this.mTextureRes == null) {
                this.mTextureRes = res;
                this.mTextureRes.retain();
            }
            if (this.mPath) {
                this.mMapMgr.removeLoadingTileImage(this.mPath);
            }
...
var Application = (function (_super) {
    ...
    Application.prototype.onUpdate = function () {
        ...
        var delay = now - this.mLastTime;
        if (delay < 0)
            delay = 0;
        core.TimeStamp.DelayTime = delay;
...
var UserSetting = (function (_super) {
    ...
    UserSetting.prototype.initObj = function () {
        ...
        this.mOperateType = -1;
        this.mStorgeCache = {};
        this.mRoleStorgeCache = {};
        this.mRoleStorgeSaveTime = 30 * 1000;
        this.mbRoleStorgeSaving = false;
    };
    UserSetting.prototype.setOperationType = function (type) {
    };
    //毫秒为单位，多久保存一次
    UserSetting.prototype.setRoleSettingSaveTime = function (time) {
        if (time <= 0)
            return;
        this.mRoleStorgeSaveTime = time;
    };
    UserSetting.prototype.setRoleName = function (name) {
        if (this.mRoleName != name) {
            this.mRoleName = name;
            var jsonStr = this.getLocalStorage(UserSetting.TYPE_STRING, this.mRoleName, "");
            if (jsonStr == null || jsonStr == "") {
                this.mRoleStorgeCache = {};
            }
            else {
                this.mRoleStorgeCache = JsUtil.JsonDecode(jsonStr);
            }
        }
    };
    UserSetting.prototype.setLocalStorge = function (key, value) {
        // if(key_ == null )
        // 	return;
    ...
    UserSetting.prototype.getLocalStorage = function (type, key, defValue) {
    ...
    UserSetting.prototype.setCommonSetting = function (type, key, value) {
        this.setLocalStorge(key, value);
    };
    UserSetting.prototype.getCommonSetting = function (type, key, def) {
        return this.getLocalStorage(type, key, def);
    };
    UserSetting.prototype.setRoleSetting = function (type, key, value) {
        //this._setSetttingStorage(UserSettingMode.Role, type, key, value);		
        var saveVal = this.mRoleStorgeCache[key];
        if (saveVal != value) {
            if (value == null) {
                delete this.mRoleStorgeCache[key];
            }
            else {
                this.mRoleStorgeCache[key] = value;
            }
            //延时保存
            if (this.mbRoleStorgeSaving == false) {
                this.mbRoleStorgeSaving = true;
                var self_2 = this;
                setTimeout(function () {
                    if (self_2.mbRoleStorgeSaving) {
                        self_2.mbRoleStorgeSaving = false;
                        self_2.setLocalStorge(self_2.mRoleName, JsUtil.JsonEncode(self_2.mRoleStorgeCache));
                    }
                }, this.mRoleStorgeSaveTime);
            }
        }
    };
    UserSetting.prototype.getRoleSetting = function (type, key, def) {
        ...
        var retVal = this.mRoleStorgeCache[key];
        if (retVal == null) {
            retVal = def;
        }
        return retVal;
    };
    UserSetting.prototype.flush = function () {
        if (this.mbRoleStorgeSaving) {
            this.mbRoleStorgeSaving = false;
            this.setLocalStorge(this.mRoleName, JsUtil.JsonEncode(this.mRoleStorgeCache));
        }
    };
    ...
    var LogicSpriteManager = (function (_super) {
        ...
        LogicSpriteManager.prototype.destory = function () {
            ...
            for (var k in this.mSkeletonResourceMap) {
                var skeRes = this.mSkeletonResourceMap[k];
                skeRes.deleteObj();
            }
            this.mSkeletonResourceMap = {};
        ...
        LogicSpriteManager.prototype.createSprite = function (type) {
            var sprite = null;
            if (type == map.SpriteType.TYPE_BONE_SPRITE) {
                sprite = map.BoneSprite.createObj();
            }
            else if (type == map.SpriteType.TYPE_FRMAE_SPRITE) {
                sprite = map.FrameSprite.createObj();
            }
            return sprite;
        };
        ...
        ///////////////////////////////////////////////////////////////////////////
        LogicSpriteManager.prototype.getBoneSkeletonResource = function (modelName) {
            ...
            if (res == null) {
                ...
                res = map.BoneSpriteSkletonResource.newObj(modelName, info, this);
...
var map;
(function (map) {
    var BoneSprite = (function (_super) {
        __extends(BoneSprite, _super);
        function BoneSprite() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        BoneSprite.prototype.initObj = function () {
            var params = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                params[_i] = arguments[_i];
            }
        ...
        BoneSprite.prototype.destory = function () {
            this._clearArmature();
            this._unLoadSkeletonResource();
            //this._unLoadTextureResource();
            this.dynamicSlotDataList.forEach(function (v) {
                v.returnToPool();
            });
        ...
        // }
        BoneSprite.prototype._loadSkeletonResource = function () {
        ...
        BoneSprite.prototype._unLoadSkeletonResource = function () {
            if (this.mSkletonResource) {
                this.mSkletonResource.unload();
                this.mSkletonResource = null;
            }
        };
        BoneSprite.prototype.onFrameEvent = function (event) {
            var eventName = event.eventObject.name ? event.eventObject.name : "";
            this._fireAnimEvent(eventName);
        };
        BoneSprite.prototype.onAnimationEvent = function (event) {
        ...
        BoneSprite.prototype._createArmature = function () {
            TLog.Assert(this.mArmatureDisplay == null && this.mSkletonResource != null);
            var modelName = this.getModelName();
            var dragonBonesData = dragonBones.EgretFactory.factory.getDragonBonesData(modelName);
            var armatureName = modelName;
            if (dragonBonesData != null && dragonBonesData.armatureNames.length == 1)
                armatureName = dragonBonesData.armatureNames[0];
            this.mArmatureDisplay = dragonBones.EgretFactory.factory.buildArmatureDisplay(armatureName, modelName);
            TLog.Assert(this.mArmatureDisplay != null, "buildArmatureDisplay failded %s", modelName);
        ...
        BoneSprite.prototype._clearArmature = function () {
            if (this.mArmatureDisplay) {
        ...
        BoneSprite.prototype._updateAnimation = function () {
            ...
            if (this._hasFlags(16 /* InvalidPause */)) {
                ...
                if (bPause) {
                    ...
                    if (this.mArmatureDisplay.animation.isPlaying == false)
                        this.mArmatureDisplay.animation.play();
                }
            }
        };
        BoneSprite.prototype.playAnimation = function () {
            if (this.mArmatureDisplay == null)
                return;
            var actionId = this.mLogicInfo[1 /* ActionId */];
            if (actionId == "" || actionId == null) {
                this.mArmatureDisplay.animation.play(null, 1);
            }
            else {
                this.mArmatureDisplay.animation.play(actionId, 1);
            }
        };
        BoneSprite.prototype._getTextureData = function (textureName) {
            var name = this.getModelName();
            var textureAtlasDataList = dragonBones.EgretFactory.factory.getTextureAtlasData(name);
        ...
        // 	}
        // }
        BoneSprite.prototype._updateBound = function () {
            ...
            var bHandleBound = false;
            var animation = this.mArmatureDisplay.animation;
            ...
            if (bHandleBound) {
                this._setFlags(2 /* InvalidActionId */);
                this._updateAnimation();
            }
        };
        BoneSprite.prototype._updatePartSkin = function (slotName, replaceSkinPath) {
            var factory = dragonBones.EgretFactory.factory;
            var armature = this.mArmatureDisplay.armature;
            ...
            var modelName = this.getModelName();
            var dragonBonesData = factory.getDragonBonesData(modelName);
            var paths = replaceSkinPath.split("/");
            if (paths.length != 2) {
                TLog.Error("changePartSkin replaceSkinPath paths:%s error!", replaceSkinPath);
            }
            //检查替换皮肤的slot是否存在	
            var skinArmatrueName = paths[0];
            var skinSlotName = paths[1];
            var skinArmatrue = dragonBonesData.getArmature(skinArmatrueName);
        ...
        BoneSprite.prototype._updateSkin = function () {
            var _this = this;
            if (this._hasFlags(64 /* InvalidSkin */)) {
                this._removeFlags(64 /* InvalidSkin */);
                do {
                    var skinArmatrueName = this.getSkinName();
                    if (skinArmatrueName == "")
                        break;
                    var factory = dragonBones.EgretFactory.factory;
                    var armature = this.mArmatureDisplay.armature;
            ...
            if (this.mPartSkinInfoList.length > 0) {
                this.mPartSkinInfoList.forEach(function (v) {
                    _this._updatePartSkin(v.slotName, v.replaceSkinPath);
                });
                this.mPartSkinInfoList.length = 0;
            }
        };
        BoneSprite.prototype._createDynamicSlotData = function (name, parent) {
            for (var _i = 0, _a = this.dynamicSlotDataList; _i < _a.length; _i++) {
                var v = _a[_i];
                if (v.name == name) {
                    v.parent = parent;
                    return v;
        ...
        BoneSprite.prototype._addChidNode = function (boneName, sprite, order, bTransform) {
            ...
            do {
                if (boneName != "" && boneName != null) {
                    var armature = this.mArmatureDisplay.armature;
                    var boneData = armature.armatureData.getBone(boneName);
                    if (boneData == null) {
                        TLog.Error("_addChidNode %s does not have boneData:%s", this.getModelName(), boneName);
                        break;
                    }
                    var dynamicSlotName = boneName + "_background"; //背景slot
                    if (order > 0) {
                        dynamicSlotName = boneName + "_foreground"; //前景slot
                    }
                    var slot = armature.getSlot(dynamicSlotName);
                    //动态创建插槽
                    if (slot == null) {
                        var slotData = this._createDynamicSlotData(dynamicSlotName, boneData);
        ...
        //=========================begin 继承SpriteBase===========================
        BoneSprite.prototype.onCameraFound = function () {
            _super.prototype.onCameraFound.call(this);
        ...
        BoneSprite.prototype.onCameraLost = function () {
            _super.prototype.onCameraLost.call(this);
            //this._unLoadTextureResource();
        ...
        BoneSprite.prototype.onMoveDirChange = function (dirIndex) {
            var leftDirs = [0, 1, 6, 7];
            var bRight = leftDirs.indexOf(dirIndex) != -1;
            if (this.mArmatureDisplay == null) {
                return false;
            }
            var handle = 0;
        ...
        //=========================end 继承SpriteBase===========================
        //===============================start 子类继承实现===========================
        BoneSprite.prototype._updateAlpha = function () {
            if (this.mArmatureDisplay) {
                this.mArmatureDisplay.alpha = (this.mAlpha / 255) * (this.mMaskAlpha / 255);
            }
        };
        BoneSprite.prototype._updateColor = function () {
            if (this.mArmatureDisplay) {
                this.mArmatureDisplay.tint = this.mTintColor;
            }
        };
        BoneSprite.prototype._updateScale = function () {
            if (this.mArmatureDisplay) {
        ...
        BoneSprite.prototype._updateRotate = function () {
            if (this.mArmatureDisplay) {
                this.mArmatureDisplay.rotation = this.mRotate;
            }
        };
        BoneSprite.prototype._updateModel = function () {
        ...
        BoneSprite.prototype.hasActionId = function (actionId) {
            if (this.mArmatureDisplay == null)
                return false;
            var armature = this.mArmatureDisplay.armature;
    ...
    map.BoneSprite = BoneSprite;
    __reflect(BoneSprite.prototype, "map.BoneSprite");
})(map || (map = {}));
var map;
(function (map) {
    //骨骼资源
    var BoneSpriteSkletonResource = (function (_super) {
        __extends(BoneSpriteSkletonResource, _super);
        function BoneSpriteSkletonResource() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        //子类复写 初始化函数
        BoneSpriteSkletonResource.prototype.initObj = function () {
            var params = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                params[_i] = arguments[_i];
            }
        ...
        //子类复写 析构函数
        BoneSpriteSkletonResource.prototype.destory = function () {
        ...
        BoneSpriteSkletonResource.prototype._loadImp = function () {
            this._loadSkeleton();
            this._loadTexture();
        };
        BoneSpriteSkletonResource.prototype._unloadImp = function () {
            this._unloadSkeleton();
            this._unloadTexture();
            //this.mLoadState = ModelLoadState.eUnLoad;
        };
        BoneSpriteSkletonResource.prototype._cancelLoadImp = function () {
            var resMgr = core.ResManager.getInstance();
            resMgr.cancelResAsyn(this);
            var textureMgr = core.TextureManager.getInstance();
            textureMgr.cancelTextureAsyn(this.texturePath, this);
        };
        BoneSpriteSkletonResource.prototype._loadSkeleton = function () {
            var resMgr = core.ResManager.getInstance();
        ...
        BoneSpriteSkletonResource.prototype._unloadSkeleton = function () {
            var factory = dragonBones.EgretFactory.factory;
            if (this.dragonBonesData) {
                factory.removeDragonBonesData(this.mModelName);
                this.dragonBonesData = null;
            }
        };
        BoneSpriteSkletonResource.prototype._loadTexture = function () {
            var resMgr = core.ResManager.getInstance();
            resMgr.loadResAsyn(this.textureJsonPath, this, core.ResourceType.TYPE_JSON);
            if (this.textureRes == null) {
                var textureMgr = core.TextureManager.getInstance();
        ...
        BoneSpriteSkletonResource.prototype._unloadTexture = function () {
            var factory = dragonBones.EgretFactory.factory;
            if (this.textureAtlasData) {
                factory.removeTextureAtlasData(this.mModelName);
                this.textureAtlasData = null;
            }
            if (this.textureRes) {
                this.textureRes.release();
        ...
        BoneSpriteSkletonResource.prototype._updateAllRes = function () {
            if (this.textureJsonRes && this.textureRes) {
                var factory = dragonBones.EgretFactory.factory;
                this.textureAtlasData = factory.parseTextureAtlasData(this.textureJsonRes.getData(), this.textureRes.getData(), this.mModelName);
                //删除json文件
                this.textureJsonRes.release();
                this.textureJsonRes = null;
            }
            if (this.textureAtlasData != null && this.dragonBonesData != null) {
                this.notifyLoadComplete();
            }
        };
        ////////////////////////////////////////////////////////////////////////
        BoneSpriteSkletonResource.prototype.onResItemLoad = function (res) {
            if (res.getKey() == this.modelJsonPath) {
                var factory = dragonBones.EgretFactory.factory;
                this.dragonBonesData = factory.parseDragonBonesData(res.getData(), this.mModelName);
            }
            else if (res.getKey() == this.textureJsonPath) {
                this.textureJsonRes = res;
                this.textureJsonRes.retain();
            }
            this._updateAllRes();
        };
        BoneSpriteSkletonResource.prototype.onResItemError = function (key) {
        };
        BoneSpriteSkletonResource.prototype.onAsynTextureSucceed = function (key, texture, textureRes) {
            TLog.Assert(this.textureRes == null);
            if (key == this.texturePath) {
                this.textureRes = textureRes;
                this.textureRes.retain();
        ...
        return BoneSpriteSkletonResource;
    }(map.SpriteResourceBase));
    map.BoneSpriteSkletonResource = BoneSpriteSkletonResource;
    __reflect(BoneSpriteSkletonResource.prototype, "map.BoneSpriteSkletonResource", ["core.ResItemCallback", "core.TextureCallback"]);
    //纹理资源
    /*
...
(function (map) {
    var FrameSprite = (function (_super) {
        ...
        FrameSprite.prototype.onAnimationIndexChange = function (actionId, index) {
            this.mSpriteDisplay.setActionAndFrameIndex(actionId, index, this.mSpriteAnimation.getCurAnimationInfo().frameCount == 1);
        };
        //-----------------------------------内部函数------------------------------------------------
        ...
        FrameSprite.prototype._updateScale = function () {
            var s = this.mPersScale * this.mScale * this.mContentScale;
...
(function (map) {
    ...
    var FramSpriteBodyPartDisplayBitmap = (function (_super) {
        ...
        FramSpriteBodyPartDisplayBitmap.prototype.getTextureByDir = function (textureRes, dirIndex) {
            ...
            if (this.mPartShowName == "") {
                ...
                hashImageKey = this.mActionId + "_" + dirIndex + "_" + this.mBodyPartInfo.name + "_" + frameIndexStr;
            }
            else {
                ...
                hashImageKey = this.mActionId + "_" + dirIndex + "_" + this.mBodyPartInfo.name + "_" + this.mPartShowName + "_" + frameIndexStr;
            }
            return textureRes.getTexture(hashImageKey);
        };
        FramSpriteBodyPartDisplayBitmap.prototype.updateDislay = function () {
            ...
            var bMirrorX = false;
            var texture = this.getTextureByDir(textureRes, this.mDirIndex);
            if (texture == null) {
                var mirrorDir = this.mBodyPartInfo.dirsMirror[this.mDirIndex];
                if (mirrorDir != null) {
                    texture = this.getTextureByDir(textureRes, mirrorDir);
                    bMirrorX = texture != null;
                }
            }
            this.mBitmap.texture = texture;
            this.mBitmap.scaleX = bMirrorX ? -1 : 1;
        };
    ...
    var FrameSpriteDisplay = (function (_super) {
        ...
        FrameSpriteDisplay.prototype.loadModelInfo = function (parent, spriteInfo) {
            ...
            this.mBodyPartDisplayList = [];
            this.mActionId = "";
            this.mDirIndex = -1;
            this.mFrameIndex = -1;
            this.mLogicSprite = parent;
            var bodyPartList = spriteInfo.mBodyPartInfoList;
            for (var _b = 0, bodyPartList_1 = bodyPartList; _b < bodyPartList_1.length; _b++) {
                var bodyPartInfo = bodyPartList_1[_b];
        ...
        FrameSpriteDisplay.prototype.setActionAndFrameIndex = function (actionId, index, bforce) {
            bforce = !!bforce;
            ...
            if (this.mFrameIndex != index || bforce) {
        ...
        FrameSpriteDisplay.prototype.restoreBodyPartDisplay = function () {
            ...
            for (var i = 0; i < this.mRestoreBodyPartDisplayList.length; i++) {
                ...
                bodyPartDisplay.scaleX = bodyPartDisplay.scaleY = 1;
            }
        ...
        FrameSpriteDisplay.prototype.joinBodyPartDisplayTo = function (target) {
            if (this.mRestoreSpriteDisplay != null || this.mBodyPartDisplayList.length == 0)
                return;
            var contentScale = this.mLogicSprite.getContentScale();
            for (var i = 0; i < this.mBodyPartDisplayList.length; i++) {
                ...
                bodyPartDisplay.scaleX = bodyPartDisplay.scaleY = contentScale;
    ...
    var FrameSpriteInfo = (function (_super) {
        ...
        FrameSpriteInfo.prototype.loadWithJson = function (rawData) {
            ...
            for (var _i = 0, bodyparts_1 = bodyparts; _i < bodyparts_1.length; _i++) {
                ...
                //镜像方向
                if (partinfo.dirsMirror) {
                    for (var strdir in partinfo.dirsMirror) {
                        var dir = JsUtil.toNumber(strdir, -1);
                        if (dir != -1) {
                            bodypartInfo.dirsMirror[dir] = partinfo.dirsMirror[dir];
                        }
                    }
                }
                //套装信息
...
(function (map) {
    ...
    var FrameSpriteTextureResource = (function (_super) {
        ...
        FrameSpriteTextureResource.prototype.requestLoadAnimTexture = function (animName) {
            ...
            var textureMgr = core.TextureManager.getInstance();
            textureMgr.loadTextureAsynWithPriority(texturePath, core.ResourcePriority.Normal, this);
            res.bloading = true;
        };
...
(function (core) {
    ...
    var GameSdk = (function (_super) {
        ...
        GameSdk.prototype.checkSdkLoadFinish = function () {
            if (this.mSrcSdkJson != null && this.mExtendSdkJson != null) {
                for (var k in this.mExtendSdkJson) {
                    this.mSrcSdkJson[k] = this.mExtendSdkJson[k];
                }
                this.initSdk(this.mSrcSdkJson);
                this.mSrcSdkJson = null;
                this.mExtendSdkJson = null;
            }
        };
        GameSdk.prototype.onInitSdkFinish = function () {
            if (this.mSdkLoadCallback) {
                this.mSdkLoadCallback.call(this.mSdkLoadCallbackObj);
            }
        };
        GameSdk.prototype.loadSdkFileAsyn = function (sdkpath, callback, obj) {
            var self = this;
            this.mSrcSdkJson = null;
            this.mExtendSdkJson = {};
            this.mSdkLoadCallback = callback;
            this.mSdkLoadCallbackObj = obj;
            ...
            if (this.mInterGameSdk && this.mInterGameSdk.loadSdkFileAsyn) {
                //loadSdkFileAsyn返回true表示要加载额外sdkconfig
                //原生端要调用onSdkConfigReturn返回
                if (this.mInterGameSdk.loadSdkFileAsyn()) {
                    this.mExtendSdkJson = null;
                }
            }
            //加载配置文件
            var t = {
                onResItemLoad: function (res) {
                    self.mSrcSdkJson = res.getData();
                    self.checkSdkLoadFinish();
                },
                onResItemError: function (key) {
                }
            };
            core.ResManager.getInstance().loadResAsynLocal(sdkpath, t, core.ResourceType.TYPE_JSON);
        };
        GameSdk.prototype.initSdk = function (json) {
            this.mConfig = new core.ConfigFile;
            this.mConfig.initWithJson(json);
            this._loginSuccessAppead = "gameKey=" + this.getStringConfigDef("GameKey", "");
            this._loginSuccessAppead = this._loginSuccessAppead + "&platform=" + this.getStringConfigDef("Platform", "");
            this._loginSuccessAppead = this._loginSuccessAppead + "&qdKey=" + this.getStringConfigDef("QD_Key", "");
            ...
            if (this.mInterGameSdk != null) {
                ...
                if (this.mInterGameSdk.checkSdkFinishAsyn == null || this.mInterGameSdk.checkSdkFinishAsyn() == false) {
                    this.onInitSdkFinish();
                }
            }
            else {
                this.onInitSdkFinish();
        ...
        GameSdk.prototype.addCmdLine = function (key, val) {
            this.mCmdListValueList[key] = val;
        };
        //////////////////////////////////////////////////////////////////////////////
        ...
        GameSdk.prototype.getDataConfigDef = function (key, def) {
            return this.mConfig.getData(key, def);
        };
        ...
        //SDK配置文件返回
        GameSdk.prototype.onSdkConfigReturn = function (jsonStr) {
            //this.fireEvent(GameSdk.SDK_FILE_LOAD_EVENT, SdkResultEvent.newObj(0, jsonStr))
            //this.mConfig = new core.ConfigFile;
            setTimeout(function () {
                if (jsonStr != "") {
                    var jsonInfo = JsUtil.JsonDecode(jsonStr);
                    this.mExtendSdkJson = jsonInfo;
                    this.checkSdkLoadFinish();
                }
            }.bind(this), 0);
        };
        ...
        GameSdk.prototype.CallAnalytics = function (eventId, eventStr) {
            if (this.mInterGameSdk == null || this.mInterGameSdk.analytics == null)
                return false;
            return this.mInterGameSdk.analytics(eventId, eventStr);
        };
        ...
        //public static SDK_FILE_LOAD_EVENT = "SDK_FILE_LOAD_EVENT";//配置文件返回
